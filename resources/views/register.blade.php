                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <fieldset>
                            ...
                            <input id="button_entrance" class="btn btn-lg btn-success btn-block" style="width: 100%" type="submit" value="Зарегистрироваться">
                        </fieldset>
                    </div>
                </div>
            </div>
        ...
        $("#button_entrance").click(function(){
            $.ajax({
                ...
                success: function(data) {
                    ...
                    {
                        document.location.href = "/login/?id_user=" + data['id_user']
                    }
                }
            });
        });
